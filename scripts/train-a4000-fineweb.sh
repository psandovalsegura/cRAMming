...
#SBATCH --job-name=fineweb-llama-a4000
...
exec python train_fineweb.py config/train_llama-2-7b_fineweb.py \
                --out_dir="/fs/nexus-scratch/psando/nanoGPT-experiments/fineweb-a4000" \
